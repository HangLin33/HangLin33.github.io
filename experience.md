...
*Shanghai, China · On-site · Dec 2025 – Present*

Focused on IPO pricing, valuation analysis, and investor demand analytics across equity financing transactions.

- Built valuation and market analytics models using **Excel and Python** to support IPO pricing and issuance strategy.
- Conducted **peer comps and factor-based valuation** (P/E, EV/EBITDA, market-cap tiers) across listed comparables.
- Analyzed **investor demand and bookbuilding dynamics**, tracking subscriptions, allocation concentration, and pricing sensitivity.
- Developed structured **ECM dashboards** summarizing issuance conditions, secondary-market performance, and investor participation.

*Tools:* Python · Excel · Valuation · IPO Analytics · Bookbuilding

---

### **Equity Capital Markets Intern — China Securities Co., Ltd.**  
*Hong Kong SAR · Hybrid · Nov 2025 – Dec 2025*

Supported Hong Kong IPO execution through investor analytics, market monitoring, and data-driven pricing support.

- Built a **Python-based database** for 50+ cornerstone investors with **$3B AUM**, improving profiling and tagging efficiency.
- Created **SQL and Excel dashboards** supporting two HK IPOs totaling **$500M**, accelerating peer comps and market updates.
- Analyzed **institutional investor behavior and allocation patterns** to inform pricing and bookbuilding decisions.
- Streamlined recurring ECM analytics workflows, improving turnaround time for deal-related market insights.

*Tools:* Python · SQL · Excel · IPO Analytics · Investor Profiling

---

## Investment Research & Consulting

### **Industry Research Intern — China Merchants Securities**  
*Shenzhen, China · On-site · Nov 2024 – Dec 2024*

- Produced **10+ industry and market research reports** using technical indicators, macro data, and commodity fundamentals.
- Co-authored a **sugar market analysis** published in *SugarTalk Magazine*, synthesizing global supply–demand dynamics.
- Built short-term **price trend and volatility tracking models** using time-series techniques.
- Generated weekly research briefs covering macro trends, futures positioning, and sector developments.

*Tools:* Python (Pandas) · Excel (PivotTables, PowerQuery) · Quantitative Research

---

### **Investment Consulting Intern — China Merchants Futures**  
*Shenzhen, China · On-site · Jul 2024 – Sep 2024*

- Analyzed **new commodity futures products** (including log contracts) by modeling global supply chains and pricing mechanisms.
- Assessed **policy impacts, demand elasticity, and cross-market relationships** to support client advisory notes.
- Conducted comparative analysis across futures varieties, evaluating correlations, volatility structures, and market behavior.
- Collaborated with senior analysts on investment commentaries integrating macro and sector-specific insights.

*Tools:* Python · Excel · Futures Analysis · Commodity Markets

---

## Strategy, Audit & Business Analytics

### **Strategy Analyst (Part-time) — Strategy&**  
*Shanghai, China · Remote · Jun 2023 – Aug 2023*

- Built **financial and operational models** (scenario analysis, financial ratios) to evaluate strategic options.
- Conducted industry benchmarking using **Wind and Capital IQ**, standardizing **200+ KPIs** across peers.
- Performed customer segmentation analysis using **SQL and Excel** to identify revenue drivers.
- Produced client-ready dashboards and insight summaries using **Tableau and PowerPoint**.

*Tools:* Excel · SQL · Tableau · Strategy Analysis

---

### **Audit Intern — BDO China (Shu Lun Pan CPAs)**  
*Beijing, China · On-site · Feb 2025 – Mar 2025*

- Automated reconciliation for **25 subsidiaries with $5B+ in assets** using SQL and Excel, reducing audit time.
- Identified financial irregularities through variance and cross-ledger analysis.
- Translated accounting datasets into structured analytical outputs supporting audit judgments.

*Tools:* SQL · Excel · Audit Analytics · Financial Analysis

---

### **Business Operations Intern — OnePlus Management**  
*Hong Kong SAR · Hybrid · Jul 2022 – Sep 2022*

- Conducted competitor benchmarking and user-behavior analysis using **Python (Pandas, Seaborn)**.
- Built acquisition and retention reports using **SQL and Excel**, identifying funnel drop-offs.
- Designed **Tableau dashboards** visualizing user activity, campaign performance, and demographics.
- Assisted in evaluating marketing A/B tests and summarizing results for strategy recommendations.

*Tools:* Python · SQL · Tableau · Business Analytics
...
- Graduate Student — Cornell University (AEM)
- Academic & Research Projects in Economics and Finance
